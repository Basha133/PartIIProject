...
opt -load /home/test/llvm/Release/lib/ProjectHelloAnnot.so -hello_annot < ${1}.bc > ${1}-annot.bc

opt -load /home/test/loom/Release/lib/LLVMLoom.so -loom -loom-file loom_inst.policy < ${1}-annot.bc > ${1}-loomed.bc

opt -load /home/test/llvm/Release/lib/TARuntimeCalls.so -runtime_calls < ${1}-loomed.bc > ${1}-preopt.bc
